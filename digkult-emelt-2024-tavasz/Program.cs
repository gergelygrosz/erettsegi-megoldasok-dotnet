...
{
    private static readonly string PathToInput = Environment.GetEnvironmentVariable("PROJECTS") + @"\erettsegi-megoldasok-dotnet\digkult-emelt-2024-tavasz\bedat.txt";
    private static readonly string PathToOutput = Environment.GetEnvironmentVariable("PROJECTS") + @"\erettsegi-megoldasok-dotnet\digkult-emelt-2024-tavasz\kesok.txt";
